...
class Summer2022Re1
{
    const GATYA_LOG = SQLConst::LOG_GATYA_SUMMER_2022_RE_1;
        ...
        switch ($rarity) {
            case self::REEF_RARE:
                $item = match (mt_rand(1, 10)) {
                    1, 2, 3 => Summer2022ReefItems::getItem($xuid, Summer2022ReefItems::PICKAXE),

                    4, 5, 6 => Summer2022ReefItems::getItem($xuid, Summer2022ReefItems::SHOVEL),

                    7, 8, 9 => Summer2022ReefItems::getItem($xuid, Summer2022ReefItems::AXE),

                    10 => Summer2022ReefItems::getItem($xuid, Summer2022ReefItems::HOE),
                };
