        ...
        $repo->getLog($xuid, SQLConst::LOG_GATYA_CHRISTMAS_2021, function (array $rows) use ($repo, $number, $p, $xuid) {
            ...
            switch (true) {
                case ($firstRand <= 5) || ($isFirst && ($firstRand <= 10)): // 0.5% (まだ1回も引いてない人は1%)
                    ...
                    GatyaManager::gatyaProcess($repo, SQLConst::LOG_GATYA_CHRISTMAS_2021, $p, SQLConst::TICKETS_CHRISTMAS_2021, 1, $item,
                ...
                default:
                    ...
                    GatyaManager::gatyaProcess($repo, SQLConst::LOG_GATYA_CHRISTMAS_2021, $p, SQLConst::TICKETS_CHRISTMAS_2021, 1,
