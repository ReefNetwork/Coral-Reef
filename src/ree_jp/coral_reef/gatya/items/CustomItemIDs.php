...
interface CustomItemIDs
{
    ...
    const SUMMER_2022_HOE = 6004;

    const HALLOWEEN_NIGHT_PICKAXE = 6011;
    const HALLOWEEN_NIGHT_SHOVEL = 6012;
    const HALLOWEEN_NIGHT_AXE = 6013;
    const HALLOWEEN_NIGHT_HOE = 6014;

    const HALLOWEEN_PARTY_PICKAXE = 6021;
