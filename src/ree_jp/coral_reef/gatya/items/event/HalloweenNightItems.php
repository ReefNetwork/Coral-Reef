...
class HalloweenNightItems
{
    const PICKAXE = "halloween_night_pickaxe";
    const SHOVEL = "halloween_night_shovel";
    const AXE = "halloween_night_axe";
    const HOE = "halloween_night_hoe";
    ...
    static function getItem(string $xuid, string $type, int $durable = 0): ?Item
    {
        switch ($type) {
            case self::PICKAXE:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::HALLOWEEN_NIGHT_PICKAXE);
                $nbt = $item->getNamedTag();
                $nbt->setString(ReefItems::REEF_SP_ITEM, self::PICKAXE);
                $item->setNamedTag($nbt);
                $item->setCustomName(TextFormat::GOLD . "Halloween" . TextFormat::DARK_PURPLE . "Night" .
                ...
                break;
            case self::SHOVEL:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::HALLOWEEN_NIGHT_SHOVEL);
                $nbt = $item->getNamedTag();
                ...
                break;
            case self::AXE:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::HALLOWEEN_NIGHT_AXE);
                $nbt = $item->getNamedTag();
                ...
                break;
            case self::HOE:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::HALLOWEEN_NIGHT_HOE);
                $nbt = $item->getNamedTag();
