...
class SnowCandyItem extends ReefItems
{
    const PICKAXE = "snow_candy_pickaxe";
    const SHOVEL = "snow_candy_shovel";
    const AXE = "snow_candy_axe";
    const HOE = "snow_candy_hoe";
    ...
    static function getItem(string $xuid, string $type, int $durable = 0): ?Item
    {
        switch ($type) {
            case self::PICKAXE:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::SNOW_CANDY_PICKAXE);
                $nbt = $item->getNamedTag();
                $nbt->setString(self::REEF_SP_ITEM, self::PICKAXE);
                $item->setNamedTag($nbt);
                $item->setCustomName(TextFormat::WHITE . "Snow" . TextFormat::RED . "Candy" .
                ...
                break;
            case self::SHOVEL:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::SNOW_CANDY_SHOVEL);
                $nbt = $item->getNamedTag();
                ...
                break;
            case self::AXE:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::SNOW_CANDY_AXE);
                $nbt = $item->getNamedTag();
                ...
                break;
            case self::HOE:
                $item = ItemFactory::getInstance()->get(CustomItemIDs::SNOW_CANDY_HOE);
                $nbt = $item->getNamedTag();
