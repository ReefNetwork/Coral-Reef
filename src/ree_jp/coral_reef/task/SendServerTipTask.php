...
class SendServerTipTask extends Task
{
    const TIPS = ["ReefServerへようこそ", "Discordサーバー(discord.gg/reef)に入ると最新の情報を受け取れます",
        ...
        "/lobbyでロビーサーバーに戻れます", "メニューが開けないなどの不具合が発生した場合は/lobbyで再度ログインをお願いします",
        "手持ちのアイテムを別のサーバーに持ち越すにはストレージを使用してください", "どのサーバーにいてもチャットをやり取りできます", "スニークしながらショップを開くと1度に大量のアイテムを購入できます",
